...
public class TC4 extends BaseTest1 {
    ...
    @Test(priority = 1, description = "FLOW - Nhóm hàng - Tổng đơn theo SP->> tặng phm", invocationCount = 1)
    public void TC04 () throws InterruptedException {
        ...
        test.pass("✅ PASS verify Nhóm hàng - Tổng đơn theo SP->> tặng phm 20k-KM-0626-074 SP C052300000457. Mã đơn: " + orderCode);
    }
}
