...
public class TC8 extends BaseTest1 {
    ...
    public void TC08 () throws InterruptedException {
        ...
        try {
            ...
            // Cách mới: dùng JavaScript tìm element chứa "Nhập mã KM" trong innerText
            // (vì xpath contains(text(),...) chỉ match text node trực tiếp, không match text trong child elements)
