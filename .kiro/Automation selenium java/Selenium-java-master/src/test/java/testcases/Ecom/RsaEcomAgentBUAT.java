...
import org.openqa.selenium.By;            // Đại diện cho 1 phần tử trên web
import org.openqa.selenium.WebDriver;   // Điều khiển trình duyệt Chrome
import org.openqa.selenium.WebElement;  // Tùy chỉnh khởi tạo Chrome
import org.openqa.selenium.chrome.ChromeDriver; // Điều kiện chờ element
import org.openqa.selenium.chrome.ChromeOptions;      // Chờ đợi element xuất hiện
