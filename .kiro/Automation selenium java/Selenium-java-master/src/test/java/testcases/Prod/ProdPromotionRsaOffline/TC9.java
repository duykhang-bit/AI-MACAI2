 ...
 options.addArguments("--start-maximized");
    ...
    public void TC09 () throws InterruptedException {
        ...
        try {
            ...
            utils.PriceSnapshotWriter.writeSnapshot("TC09", _tongTien, _giamGia, _tamTinh, _allPrices);
            tcVerifyPrice.info("📸 [TC09] tongTien=" + _tongTien
                    + " | giamGia=" + _giamGia + " | tamTinh=" + _tamTinh);
            tcVerifyPrice.info("📋 All prices: " + _allPrices);
            tcVerifyPrice.pass("✅ [TC09] Auto-detect giá xong - kiểm tra snapshot để update");
