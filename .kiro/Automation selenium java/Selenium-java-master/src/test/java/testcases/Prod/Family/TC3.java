...
public class TC3 extends BaseTest1 {
    ...
    public void testCreateOrderFlow() throws InterruptedException {
        ...
        /*
         * =========================
         * TC06 - NHẬP MÃ INSIDE 62372
         * =========================
         */
        ExtentTest tc06 = test.createNode("TC06 - Nhập mã inside 62372");
        ...
        insideInput.clear();
        insideInput.sendKeys("62372");
        Thread.sleep(1500);

        // Click chọn kết quả "Tống Thị Diệu Quỳnh (62372)"
        WebElement insideOption = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//*[contains(text(),'Tống Thị Diệu Quỳnh') or contains(text(),'(62372)')]")));
        insideOption.click();
        Thread.sleep(500);
        ...
        Thread.sleep(2000);
        tc06.pass("Đã nhập mã inside 62372, chọn Tống Thị Diệu Quỳnh và xác nhận");
