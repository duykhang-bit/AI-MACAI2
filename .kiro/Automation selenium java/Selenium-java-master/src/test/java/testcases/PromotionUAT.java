...
public class PromotionUAT extends BaseTest1 {
        ...
        public void testCreatePromotionFlowNhomCTKMSanphamUAT() {
                ...
                String promoName = "Automation test time 59s 25052026_115716";
                ...
                campaignBox.sendKeys("CD-1225-073");
        ...
        // wait.until(ExpectedConditions.elementToBeClickable(
        // By.xpath("//div[contains(@class,'ant-select-item-option') and
        // contains(.,'CD-1225-237')]")))
        // .click();
        ...
        // wait.until(ExpectedConditions.elementToBeClickable(
        // By.xpath("//div[contains(@class,'ant-select-item-option-content') and
        // contains(.,'Khuyến mãi có liên quan đến giá trị bill')]")))
        // .click();
        ...
        // // CHỌN OPTION TRONG TABLE
        // By optionGT = By.xpath(
        // "//td[contains(@class,'ant-table-cell') and
        // contains(@class,'ant-table-selection-column')]");
        ...
        // // Pop_up đồng ý
        // By btnDongYBy = By.xpath(
        // "//div[contains(@class,'ant-modal-footer')]//button[.//span[normalize-space()='Đồng
        // ý']]"
        // );
